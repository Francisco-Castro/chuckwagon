defmodule ChuckwagonWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChuckwagonWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChuckwagonWeb.Gettext, "errors", msg, opts)
    end
  end
